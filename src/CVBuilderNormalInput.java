...
public class CVBuilderNormalInput extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    CVBuilderNormalInput frame = new CVBuilderNormalInput();
    ...
    public CVBuilderNormalInput() {
        ...
        JLabel lblPremiumSubscription = new JLabel("Normal User Subscription");
        ...
        button.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                ...
                try {
                    ...
                    String query = "INSERT INTO cvbuildernormal (name, email, phone) VALUES (?, ?, ?)";
                    ...
                    if (i > 0) {
                        JOptionPane.showMessageDialog(button, "Registered successfully! Enjoy the  features!");
                        dispose();
