...
public class UserLoginFrame extends JFrame {
	...
	public UserLoginFrame() {
		...
		button_2.setBounds(100, 253, 129, 38);
		panel.add(button_2);
		
		Button button_3 = new Button("Normal");
		...
		button_3.setFont(new Font("Century Gothic", Font.PLAIN, 20));
		button_3.setForeground(new Color(255, 140, 0));
		button_3.setBackground(new Color(230, 230, 250));
		button_3.setBounds(340, 253, 155, 38);
		panel.add(button_3);
